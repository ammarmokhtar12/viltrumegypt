      ...
      <main className="min-h-screen bg-background">
        <div className="px-5 pb-12 pt-44 text-center sm:pb-20 sm:pt-56 bg-surface/50 border-b border-border-light">
          ...
          <form onSubmit={handleSearchSubmit} className="mt-12 max-w-md mx-auto relative">
            ...
            <button
              type="submit"
              className="absolute right-2 top-2 bottom-2 px-5 bg-accent text-white text-[10px] font-semibold uppercase tracking-widest rounded-lg hover:bg-accent-glow transition-colors flex items-center justify-center font-sans"
            >
              Search
            </button>
          </form>
