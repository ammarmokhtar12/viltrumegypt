    ...
    <section className="border-t border-border-light pt-16 mt-16">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-12">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-accent text-white text-[11px] font-bold uppercase tracking-[0.15em] rounded-xl transition-all hover:opacity-90 active:scale-95 shadow-lg shadow-primary/10"
        >
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="flex items-center gap-2 px-8 py-3.5 bg-accent text-white text-[11px] font-bold uppercase tracking-[0.15em] rounded-xl transition-all hover:opacity-90 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-primary/10"
              >
                {submitting ? (
                  <>
