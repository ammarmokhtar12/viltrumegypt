    ...
    >
      <div className="flex flex-col items-center gap-8">
        <div className="relative flex items-center justify-center w-44 h-44">
          ...
          />
          <div className="absolute inset-6 rounded-full bg-accent/5 viltrum-pulse-ring" />
          ...
          >
            <div className="absolute top-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-accent rounded-full shadow-[0_0_8px_rgba(26,26,26,0.15)]" />
          </div>
        </div>
        ...
        <div className="w-56 h-[2px] bg-accent/10 rounded-full overflow-hidden">
          <div className="h-full bg-accent rounded-full viltrum-progress-bar" />
        </div>
      </div>
    </div>
  );
