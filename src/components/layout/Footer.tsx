...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0a] text-white pt-16 pb-8 font-sans relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-accent/3 rounded-full blur-[200px] pointer-events-none" />
      <div className="absolute top-1/2 right-1/3 translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-accent-blue/3 rounded-full blur-[200px] pointer-events-none" />
