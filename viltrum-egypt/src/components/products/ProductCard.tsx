      ...
      <Link href={`/products/${product.id}`} className="block">
        ...
        <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl bg-white border border-border-light shadow-sm transition-all duration-500 group-hover:shadow-lg group-hover:shadow-black/5 group-hover:-translate-y-1.5">
          ...
          <div className="absolute top-6 left-6 z-20">
            {isPromo ? (
              <div className="backdrop-blur-md text-[9px] uppercase font-bold px-3 py-1.5 rounded-full border shadow-sm tracking-widest font-sans bg-primary text-white border-white/10 flex items-center gap-1.5 animate-pulse">
              ...
              <div
                className={`backdrop-blur-md text-[9px] uppercase font-semibold px-3 py-1.5 rounded-full border shadow-sm tracking-widest font-sans ${
                  isComingSoon
                    ? "bg-primary text-white border-white/10"
                    : "bg-white/90 text-primary border-border-light"
                }`}
              >
                {isComingSoon ? "Coming Soon" : "New Arrival"}
              </div>
            )}
          </div>
          ...
          {isComingSoon && (
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/20 group-hover:bg-black/40 transition-colors duration-500">
