...
export default function HeroSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full min-h-screen min-h-[700px] flex items-center justify-center overflow-hidden"
    >
      <div className="absolute inset-0 z-0">
        <Image
          src="/products/thragg-front.png"
          alt="Viltrum compression wear"
          fill
      ...
      <div className="relative z-10 w-full max-w-4xl px-6 flex flex-col items-center text-center pt-32 pb-20">
        <div
          ref={badgeRef}
          className="flex items-center gap-2 mb-6 bg-white/85 backdrop-blur-sm text-primary px-5 py-2 rounded-full border border-border-light shadow-sm opacity-0 select-none"
        >
        ...
        <div className="mb-12">
          <h1
            ref={title1Ref}
            className="text-[15vw] md:text-[12vw] type-brand leading-[0.85] opacity-0"
          >
            VILTRUM
          </h1>
